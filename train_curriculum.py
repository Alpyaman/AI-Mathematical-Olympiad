...
def create_stage1_arithmetic(num_problems=2000):
...
def create_stage2_multistep(num_problems=2000):
...
def create_stage3_algebra(num_problems=2000):
...
def main():
    ...
    stage1_problems = create_stage1_arithmetic(CONFIG["problems_per_stage"])
    stage2_problems = create_stage2_multistep(CONFIG["problems_per_stage"])
    stage3_problems = create_stage3_algebra(CONFIG["problems_per_stage"])
